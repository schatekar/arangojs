...
- [API](README.md#api)
    - [Database API](README.md#database-api)
        ...
        - [Accessing Collections](readme.md#accessing-collections)
            ...
            - [database.listCollections](readme.md#databaselistCollections)
            - [database.collections](readme.md#databasecollections)
        - [Accessing graphs](readme.md#Accessing-graphs)
        	- [database.graph](readme.md#databasegraph)
        ...
        - [Transactions](readme.md#transactions)
           - [database.transaction](readme.md#databasetransaction)
        - [Queries](readme.md#Queries)
           - [database.query](readme.md#databasequery)
           - [aqlQuery](readme.md#aqlQuery)
        - [Managing AQL user functions](readme.md#Managing-AQL-user-functions)
           - [database.listFunctions](readme.md#databaselistFunctions)
           - [database.createFunction](readme.md#databasecreateFunction)
           - [database.dropFunction](readme.md#databasedropFunction)
        - [Arbitrary HTTP routes](readme.md#Arbitrary-HTTP-routes)
           - [database.route](readme.md#databaseroute)
    - [Cursor API](readme.md#Cursor-API)
        - [cursor.count](readme.md#cursorcount)
        - [cursor.all](readme.md#cursorall)
        - [cursor.next](readme.md#cursornext)
        - [cursor.hasNext](readme.md#cursorhasNext)
        - [cursor.each](readme.md#cursoreach)
        - [cursor.every](readme.md#cursorevery)
        - [cursor.some](readme.md#cursorsome)
        - [cursor.map](readme.md#cursormap)
        - [cursor.reduce](readme.md#cursorreduce)
    - [Route API](readme.md#Route-API)
        - [route.route](readme.md#routeroute)
        - [route.get](readme.md#routeget)
        - [route.post](readme.md#routepost)
        - [route.put](readme.md#routeput)
        - [route.patch](readme.md#routepatch)
        - [route.delete](readme.md#routedelete)
        - [route.head](readme.md#routehead)
        - [route.request](readme.md#routerequest)
    - [Collection API](readme.md#Collection-API)
        - [Getting information about the collection](readme.md#Getting-information-about-the-collection)
            - [collection.get](readme.md#collectionget)
            - [collection.properties](readme.md#collectionproperties)
            - [collection.count](readme.md#collectioncount)
            - [collection.figures](readme.md#collectionfigures)
            - [collection.revision](readme.md#collectionrevision)
            - [collection.checksum](readme.md#collectionchecksum)
        - [Manipulating the collection](readme.md#Manipulating-the-collection)
            - [collection.create](readme.md#collectioncreate)
            - [collection.load](readme.md#collectionload)
            - [collection.unload](readme.md#collectionunload)
            - [collection.setProperties](readme.md#collectionsetProperties)
            - [collection.rename](readme.md#collectionrename)
            - [collection.rotate](readme.md#collectionrotate)
            - [collection.truncate](readme.md#collectiontruncate)
            - [collection.drop](readme.md#collectiondrop)
        - [Manipulating indexes](readme.md#Manipulating-indexes)
            - [collection.createIndex](readme.md#collectioncreateIndex)
            - [collection.createCapConstraint](readme.md#collectioncreateCapConstraint)
            - [collection.createHashIndex](readme.md#collectioncreateHashIndex)
            - [collection.createSkipList](readme.md#collectioncreateSkipList)
            - [collection.createGeoIndex](readme.md#collectioncreateGeoIndex)
            - [collection.createFulltextIndex](readme.md#collectioncreateFulltextIndex)
            - [collection.index](readme.md#collectionindex)
            - [collection.indexes](readme.md#collectionindexes)
            - [collection.dropIndex](readme.md#collection.dropIndex)
        - [Simple queries](readme.md#Simple-queries)
            - [collection.all](readme.md#collectionall)
            - [collection.any](readme.md#collectionany)
            - [collection.first](readme.md#collectionfirst)
            - [collection.last](readme.md#collectionlast)
            - [collection.byExample](readme.md#collectionbyExample)
            - [collection.firstExample](readme.md#collectionfirstExample)
            - [collection.removeByExample](readme.md#collectionremoveByExample)
            - [collection.replaceByExample](readme.md#collectionreplaceByExample)
            - [collection.updateByExample](readme.md#collectionupdateByExample)
            - [collection.lookupByKeys](readme.md#collectionlookupByKeys)
            - [collection.removeByKeys](readme.md#collectionremoveByKeys)
        - [Bulk importing documents](readme.md#Bulk-importing-documents)
            - [collection.import](readme.md#collectionimport)
        - [Manipulating documents](readme.md#Manipulating-documents)
            - [collection.replace](readme.md#collectionreplace)
            - [collection.update](readme.md#collectionupdate)
            - [collection.remove](readme.md#collectionremove)
            - [collection.list](readme.md#collectionlist)
    - [DocumentCollection API](readme.md#DocumentCollection-API)
        - [documentCollection.document](readme.md#documentCollectiondocument)
        - [documentCollection.save](readme.md#documentCollectionsave)
    - [EdgeCollection API](readme.md#EdgeCollection-API)
        - [edgeCollection.edge](readme.md#edgeCollectionedge)
        - [edgeCollection.save](readme.md#edgeCollectionsave)
        - [edgeCollection.edges](readme.md#edgeCollectionedges)
        - [edgeCollection.inEdges](readme.md#edgeCollectioninEdges)
        - [edgeCollection.outEdges](readme.md#edgeCollectionoutEdges)
        - [edgeCollection.traversal](readme.md#edgeCollectiontraversal)
    - [Graph API](readme.md#Graph-API)
        - [graph.get](readme.md#graphget)
        - [graph.create](readme.md#graphcreate)
        - [graph.drop](readme.md#graphdrop)
        - [Manipulating vertices](readme.md#Manipulating-vertices)
            - [graph.vertexCollection](readme.md#graphvertexCollection)
            - [graph.addVertexCollection](readme.md#graphaddVertexCollection)
            - [graph.removeVertexCollection](readme.md#graphremoveVertexCollection)
        - [Manipulating edges](readme.md#Manipulating-edges)
            - [graph.edgeCollection](readme.md#graphedgeCollection)
            - [graph.addEdgeDefinition](readme.md#graphaddEdgeDefinition)
            - [graph.replaceEdgeDefinition](readme.md#graphreplaceEdgeDefinition)
            - [graph.removeEdgeDefinition](readme.md#graphremoveEdgeDefinition)
        - [graph.traversal](readme.md#graphtraversal)
    - [GraphVertexCollection API](readme.md#GraphVertexCollection-API)
        - [graphVertexCollection.vertex](readme.md#graphVertexCollectionvertex)
        - [graphVertexCollection.save](readme.md#graphVertexCollectionsave)
    - [GraphEdgeCollection API](readme.md#GraphEdgeCollection-API)
        - [graphEdgeCollection.edge](readme.md#graphEdgeCollectionedge)
        - [graphEdgeCollection.save](readme.md#graphEdgeCollectionsave)
        - [graphEdgeCollection.edges](readme.md#graphEdgeCollectionedges)
        - [graphEdgeCollection.inEdges](readme.md#graphEdgeCollectioninEdges)
        - [graphEdgeCollection.outEdges](readme.md#graphEdgeCollectionoutEdges)
        - [graphEdgeCollection.traversal](readme.md#graphEdgeCollectiontraversal)
